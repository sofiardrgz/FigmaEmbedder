...
export default function EmbeddableDashboard({ 
  ...
  const DashboardContent = () => (
    <div className={`flex text-gray-300 rounded-[10px] overflow-hidden ambient-bg ${className}`} style={{ backgroundColor: '#1b1a19', maxWidth: '980px', height: '90vh', margin: '0 auto' }} data-testid="embeddable-dashboard">
      {showSidebar && <Sidebar />}
