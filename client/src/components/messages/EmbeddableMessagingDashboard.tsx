  ...
  const DashboardContent = () => (
    ...
    >
      <div className="flex-1 flex flex-col">
        {/* Header */}
        <header className="flex h-16 shrink-0 items-center gap-2 border-b border-gray-700 px-6 ambient-bg" style={{ backgroundColor: '#2E2E2E' }}>
        ...
        <div className="flex-1 flex overflow-hidden">
          {/* Message List */}
          <div className="w-80 border-r border-gray-700 ambient-bg" style={{ backgroundColor: '#2E2E2E' }}>
    ...
    return (
      ...
      >
        <SafariBrowserFrame url="messages.app.missioncontrol.com">
          <div className="flex h-screen rounded-[10px] overflow-hidden ambient-bg" style={{ backgroundColor: '#2E2E2E' }}>
            <div className="flex-1 flex flex-col">
              {/* Header */}
              <header className="flex h-16 shrink-0 items-center gap-2 border-b border-gray-700 px-6 ambient-bg" style={{ backgroundColor: '#2E2E2E' }}>
                <div className="flex items-center gap-2">
