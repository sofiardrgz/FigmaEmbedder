  ...
  Dashboard: (
    <div className="p-6">
      ...
      <div className="grid grid-cols-3 gap-4 mb-6">
        ...
        <div className="bg-gray-800/50 p-4 rounded-lg">
          <div className="text-sm text-gray-400">Answered Calls</div>
          <div className="text-2xl font-bold text-gray-300">400</div>
...
export default function Demo() {
  ...
  useEffect(() => {
    let currentIndex = 0;
    console.log("Starting demo animation with", navigationItems.length, "items");
    ...
    return () => {
      console.log("Clearing demo animation interval");
  ...
  return (
    <div 
      className="flex text-gray-300 rounded-[15px] overflow-hidden ambient-bg" 
      style={{ backgroundColor: '#0d0d0d', width: '900px', height: '100vh', margin: '0 auto' }}
    >
      {/* Sidebar */}
